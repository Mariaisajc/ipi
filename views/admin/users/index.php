                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>Usuario</th>
                            <th>Nombre</th>
                            <th class="text-center">Formularios</th> <!-- MODIFICADO -->
                            <th>Rol</th>
                            <th>Empresa</th>
                            <th>Estado</th>
                            <th>Acciones</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($user['assigned_forms_count'] > 0): ?>
                                    <span class="badge bg-primary rounded-pill">
                                        <?= $user['assigned_forms_count'] ?>
                                    </span>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
...
// Abrir modal de confirmación (MODIFICADO)
...
// Escuchar el envío del formulario de eliminación (NUEVO)
